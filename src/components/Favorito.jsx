          ...
          <div className="card mb-3 mx-5 rounded" key={pelicula.id}>
            ...
            ">
                ...
                <div className='d-flex mt-3 g-3 '>
                  ...
                  {pelicula.type === "movie" && (
                    <button className='btn btn-primary my-3 mx-2' onClick={() => getDetailMovie(pelicula.id, pelicula.type)}>
                      Ver Trailer
                    </button>
                  )}
                 {/*<button className='btn btn-primary my-3 mx-2' onClick={() => getDetailMovie(pelicula.id, pelicula.type)}>Ver Trailer</button>*/}
