     ...
     if (logIn) {
       return (
         <div className="container-fluid bg-primary d-flex justify-content-around py-2 align-items-center ">
           ...
           <a className="btn btn-success h-75 fs-5" href="/">
             Log out
           </a>
         </div>
       );
             ...
             <div className ="modal-dialog ">
               <div className ="modal-content  bg-primary">
                 ...
                 <div className ="mb-3">
                   ...
                   <div className ="mb-3">
                       <label for="Contraseña" className ="form-label fs-3">Contraseña</label>
                       <input className ="form-control" id="Contraseña" type="password"></input>
                   </div>
                 </div>
                 <div className ="modal-footer border-0 flex-column pt-0 pb-5">
                   <button type="button" className ="btn btn-success mx-auto mb-2 px-5" data-bs-dismiss="modal" >
                     Aceptar
                   </button>
                   <div>
                   <a href="/" className=" text-white p-2 ">Registrarse</a>
                   <a href="/" className=" text-white p-2 ">¿Olvidaste tu contraseña?</a>
